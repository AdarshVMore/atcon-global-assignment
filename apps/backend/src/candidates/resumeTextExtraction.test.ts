...
import { extractResumeText, UnsupportedResumeFormatError } from "./resumeTextExtraction.ts";

const PDF_FIXTURE_PATH = new URL("./__fixtures__/sample-resume.pdf", import.meta.url).pathname;
const DOCX_FIXTURE_PATH = new URL("./__fixtures__/sample-resume.docx", import.meta.url).pathname;
