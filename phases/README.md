...
| 16 | [16-final-assignment-preparation.md](16-final-assignment-preparation.md) | Submission and demonstration prep | [x] Complete (demo video is the user's to record) |
| — | [assignment-coverage-checklist.md](assignment-coverage-checklist.md) | Cross-cutting checklist to verify before submission | [x] Complete (demo video is the user's to record) |
